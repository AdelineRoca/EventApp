...
import lightning from "../../../../media/images/Banners/reggae.png";
...
import "./LightningReggaeFestivalPage.css";
import tickets from "./Tickets.js";
import { useState } from "react";
import background from "./../../../../media/images/BK/Concert9.jpg";

function LightningReggaeFestivalEvent() {
  ...
  return (
    <div
      className="LightningReggaeFestivalEvent"
      style={{
...
export default LightningReggaeFestivalEvent;
