...
import "./MestesugulVietiiPage.css";
import tickets from "./Tickets.js";
import { useState } from "react";
import background from "./../../../../media/images/BK/teatru6.jpg";

function MestesugulVietiiEvent() {
  ...
  return (
    <div
      className="MestesugulVietiiEvent"
      style={{
        ...
        <Card.Body>
          ...
          <ListGroup className="list-group-flush">
            <ListGroup.Item>
              ...
              >
                <ImLocation />
                Teatrul Bulandra - Sala Liviu Ciulei, Bucuresti{" "}
...
export default MestesugulVietiiEvent;
