...
import thedeaddaisies from "../../../../media/images/Banners/daisies.png";
...
import background from "./../../../../media/images/BK/Concert11.jpg";

function TheDeadDaisiesEvent() {
...
export default TheDeadDaisiesEvent;
