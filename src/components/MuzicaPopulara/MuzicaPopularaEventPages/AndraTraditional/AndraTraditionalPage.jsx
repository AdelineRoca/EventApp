...
function AndraTraditionalEvent() {
  ...
  return (
    <div
      className="AndraTraditionalEvent"
      style={{
    ...
    >
      ...
      >
        ...
        <Card.Body>
          ...
          >
            Andra si Fratii Advanov - Traditional
          </Card.Title>
          <hr
            style={{
              borderColor: "grey",
...
export default AndraTraditionalEvent;
